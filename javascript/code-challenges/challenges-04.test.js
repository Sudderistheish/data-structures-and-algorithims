...
const sortBackwards = (arr) => {
  ...
  const sortedArray = [...numbers].sort(compareNumbers);
...
function App() {
  const strings = ['Alphabet', 'Zebra', 'alphabet', 'carrot'];
  const sortedStrings = alphabetize(strings);
  return (
    <div>
      <h1>Sorted Strings:</h1>
      <ul>
...
const sortByPrice = (arr) => {
  ...
  export default MyComponent;// Solution code here...
