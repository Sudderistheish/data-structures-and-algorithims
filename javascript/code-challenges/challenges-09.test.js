...
const updateNumbers = (obj) => {
  ...
  const updatedNumbers = Object.entries(phoneNumbers).map(
...
const hasChildrenValues = (arr, character) => {
  const characterObject = arr.find((obj) => obj.name === character);

  return (
    characterObject &&
    Object.prototype.hasOwnProperty.call(characterObject, "children")
  );
};
...
const totalCharacters = (arr) => {
  return arr.some((data) => Object.values(data).includes(character));
};
